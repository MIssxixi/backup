...
Configuration="Debug"
FtpIpaName="/tianxiao/tianxiao/genshuixue_tianxiao_debug.ipa"
FtpArchiveName="/tianxiao/tianxiao/genshuixue_tianxiao_debug.xcarchive.zip"
#FtpIpaName="/tianxiao/erp/genshuixue_tianxiao_erp_debug.ipa"
#FtpArchiveName="/tianxiao/erp/genshuixue_tianxiao_erp_debug.xcarchive.zip"

if [ ! -d "tianxiao-iphone" ]; then
git clone -b dev-erp git@git.baijiahulian.com:tianxiao-base/tianxiao-iphone.git
fi

cd "tianxiao-iphone"
git reset --hard
git checkout "dev-erp"
git pull
