...
FtpIpaName="/tianxiao/tianxiao/genshuixue_tianxiao_release.ipa"
FtpArchiveName="/tianxiao/tianxiao/genshuixue_tianxiao_release.xcarchive.zip"

if [ ! -d "tianxiao-iphone" ]; then
git clone -b dev-tianxiao git@git.baijiahulian.com:tianxiao-base/tianxiao-iphone.git
fi

cd "tianxiao-iphone"
git reset --hard
git checkout "dev-tianxiao"
git pull
